...
clear_screen() {
     clear
     echo "_______                         _____ _   _______        _              _ " 
     ...
     echo "_\_____|_|  \___/ \_/\_/ |_| |_|_|   |_|    |_|\___||___/\__|_| |_|\___|\__|"     
     sleep 3
...
download_package() {
    ...
    sudo wget "https://gitlab.crown.tech/crown/crown-core/-/jobs/5285/artifacts/download" -O $dir/crown.zip
}
